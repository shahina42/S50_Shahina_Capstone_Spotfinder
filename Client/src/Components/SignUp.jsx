...
<h2 className=' text-4xl text-black mt-4  ml-32  font-semibold'>Sign Up</h2><br />

<input type="text" className='block w-80 border border-gray-300 rounded-md ml-6 py-2 px-3 mb-3' placeholder='Name'/><br />
<input type="text" className='block w-80 border border-gray-300 rounded-md ml-6 py-2 px-3 mb-3' placeholder='Email' /><br />
