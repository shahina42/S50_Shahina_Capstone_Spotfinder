  ...
  return (
    <div className="bg-cover h-screen " style={{ backgroundImage: `url(${bk})` }}>
      ...
      <div className='flex justify-end'>
        ...
        <div className='Descrip '><p className=' pr-6 pt-20 w-96 text-2xl font-josefin font-light'>We believe in the beauty of exploration and the joy of finding hidden gems.
          we're here to guide you to the best destinations for relaxation and rejuvenation. Our platform empowers
          users like you to share your favorite nature reserve places and cafes, creating a vibrant community of
          nature enthusiasts and cafe connoisseurs.</p></div>
